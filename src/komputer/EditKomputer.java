 ...
 * @author User
 */
public class EditKomputer extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditKomputer
     */
    public EditKomputer() {
        this(null);
    }

    public EditKomputer(String idKomputer) {
    ...
    private void muatData(){
        ...
        try{
            ...
            String sql = "SELECT * FROM tb_komputer WHERE id_komputer=?";
            ...
            if(rs.next()){
                ...
                txtId.setText(rs.getString("id_komputer"));
                txtNomorKomputer.setText(rs.getString("nomor_komputer"));
                cbStatus.setSelectedItem(rs.getString("status_komputer"));
                txtKeterangan.setText(rs.getString("keterangan"));

            }else{

                JOptionPane.showMessageDialog(null,"Data komputer tidak ditemukan!");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(EditKomputer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditKomputer().setVisible(true);
            }
        });
    }
